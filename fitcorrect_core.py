...
# NEW: Do NOT allow deeper than calibration by more than this margin.
...
# ============================================================
# CALIBRATION (stores user's MAX ROM hit position)
# ============================================================
...
# ============================================================
# EVALUATION (ROM WINDOW: NOT TOO SHALLOW, NOT TOO DEEP)
# ============================================================
def evaluate_exercise_hit(title: str, lm, profile: dict, difficulty: str, smoothers: dict):
    ...
    if title == "Bodyweight Squat":
        ...
        if deep_bad:
            info = f"Too deep vs calibration | Knee {knee:.0f}° (< {hit - ROM_DEEP_MARGIN_DEG[difficulty]:.0f}°)"
        else:
    ...
    if title == "Lunge":
        ...
        if deep_bad:
            info = f"Too deep vs calibration | min knee {cur_min:.0f}°"
        else:
    ...
    if title == "Push-Up":
        ...
        if deep_bad:
            info = f"Too deep vs calibration | Elbow {elbow:.0f}°"
        else:
...
# ============================================================
# REP LATCHING (GOOD stays once hit; resets when rep ends)
# ============================================================
def rep_state_new():
